    ...
    <div className={clsx("page-container", "animate-fade-in")}>
      <header className={styles.pageHeader}>
        ...
        <div className={styles.headerActions}>
          ...
          <Link href="/operator/tickets/new" className={pageStyles.btnPrimary}>
          ...
          <table className={pageStyles.table}>
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr key={ticket.id}>
                  <td><Link href={`/operator/tickets/${ticket.id}`} className={pageStyles.idLink}>#{ticket.ticketNumber.slice(-4)}</Link></td>
                  <td>
                  ...
                  <td className={styles.actionWrapper}>
                    ...
                    {openMenuId === ticket.id && (
                      <div className={styles.dropdownMenu} onClick={(e) => e.stopPropagation()}>
                        <Link href={`/operator/tickets/${ticket.id}`} className={styles.dropdownItem}>
          ...
          {isLoading ? (
            ...
            tickets.map((ticket) => (
              <div key={ticket.id} className={styles.mobileCard}>
                  ...
                  <div className={styles.cardAction}>
                    ...
                    {openMenuId === ticket.id && (
                      <div className={styles.dropdownMenu} style={{ right: 0, top: 32 }} onClick={(e) => e.stopPropagation()}>
                        <Link href={`/operator/tickets/${ticket.id}`} className={styles.dropdownItem}>Просмотр</Link>
                ...
                <Link href={`/operator/tickets/${ticket.id}`} className={styles.cardBodyLink}>
