    ...
    <div className={clsx("page-container", styles.container, "animate-fade-in")}>
      <header className={styles.header}>
        ...
        <div className={styles.headerActions}>
          <Link href="/operator/tickets" className={styles.btnSecondary}>
            Все заявки
          </Link>
          <Link href="/operator/tickets/new" className={styles.btnPrimary}>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                {newTickets?.map((ticket) => {
                  ...
                  return (
                    <tr key={ticket.id}>
                      <td><Link href={`/operator/tickets/${ticket.id}`} className={styles.idLink}>#{ticket.ticketNumber.slice(-4)}</Link></td>
                      <td>
